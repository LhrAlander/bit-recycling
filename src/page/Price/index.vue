<template>
	<div class="g-price">
		...
		<div class="g-bd">
			...
			<div class="u-detail">
				<div class="top">
					<div class="wrapper">
						<div class="left">
							<img src="/static/icon/order-selected.png" alt="order" class="order">
							交易量(笔)
						</div>
				...
				<div class="bottom">
					<div class="wrapper">
						<div class="left">
							<img src="/static/icon/sell-selected.png" alt="sell" class="sell">
							交易金额
						</div>
		...
		<div class="g-ft" ref='ft'>
			<div class="left">
				<img src="/static/icon/recycleBox.png" alt="recycleBox" class='recycle-box'>
				<span>回收箱</span>
			</div>
			<div class="right">
